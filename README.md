...
Typischer Business Class Preis NewYork Shanghain Preis: 1.500 * 2 = 3k/Anzahl der übrigen Sitze 

To-Do:
Flo:
 - Top Down View: Normale Abmaße, Masßkette (Business Sitzbreite + Gang + MItte + Gang + Rechts)
 - Top Down View: Neue Ambmaße, Version mit Pod (Maßkette)
 - Liegeposition: Fehlendes Maß antragen und in Farbe von Präsi Colorcode: #D5CEA3
 - Alle Zeichnungen in ColorCode: #D5CEA3
 - Wenn Zeit über PodSkizzen (Konzept Falttür)

Marcel:
 - Buisness Seat Rechnung
 - Anpassen von Story
 - Präsident ausbauen
